...
class ResearchModels():
    def __init__(self, nb_classes, model, seq_length,
        ...
        # optimizer = RMSprop(lr=.001, rho=0.9, decay=0.000001)
    ...
    def lstm(self):
        ...
        # model.add(LSTM(4096, return_sequences=False, input_shape=self.input_shape, dropout=0.5))
        # model.add(LSTM(512, return_sequences=False, input_shape=self.input_shape, dropout=0.5))
